...
{
    class FlattenedReflexive
    {
        private bool _expanded = true;
        private ReflexiveData _template;
        private ReflexiveData _activeReflexive;
        private List<ReflexiveData> _synchronizedReflexives = new List<ReflexiveData>();
        private FlattenedReflexive _parent;
        private ReflexivePage _lastPage;
        private ObservableCollection<MetaField> _loadedFields = new ObservableCollection<MetaField>();
    ...
    public class ReflexiveFlattener : IMetaFieldVisitor
    {
        ...
        {
            ReflexiveData reflexive = (ReflexiveData)sender;
