...
namespace Blamite.Flexibility.Settings
{
    ...
    public class SettingsGroup
    {
        ...
        private Dictionary<string, SettingsGroup> _groups = new Dictionary<string, SettingsGroup>();
        ...
        {
            return GetSettingByPath<T>(path, (group, name) => ConvertSetting<T>(group._settings[name]));
        }
        ...
        {
            return GetSettingByPath<SettingsGroup>(path, (group, name) => group._groups[name]);
        }
