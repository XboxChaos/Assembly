...
namespace Blamite.Flexibility
{
    ...
    {
        private Dictionary<string, EngineDescription> _enginesByName = new Dictionary<string, EngineDescription>();
        private Dictionary<string, EngineDescription> _enginesByVersion = new Dictionary<string, EngineDescription>();
