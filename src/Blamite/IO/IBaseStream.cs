...
namespace Blamite.IO
{
    ...
    /// User classes should not implement this directly - implement <see cref="System.IO.Stream"/> and create an <see cref="EndianReader"/>, <see cref="EndianWriter"/>, or <see cref="EndianStream"/> from it instead.
    /// </summary>
