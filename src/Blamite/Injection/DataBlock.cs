...
namespace Blamite.Injection
{
    ...
    /// <summary>
    /// Contains information about a stringID reference in a <see cref="DataBlock"/> which needs to be changed to point to a stringID in the new cache file.
    /// </summary>
    ...
    public class DataBlock
    {
        ...
        /// <summary>
        /// Gets a list of stringIDs in this block that need to be changed in order to correctly point to strings in the new cache file.
        /// </summary>
