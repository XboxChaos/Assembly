...
namespace Blamite.Blam.SecondGen.Localization
{
	...
	/// </summary>
	public class SecondGenMultilingualStringList
	{
		private readonly StructureLayout _layout;

		public SecondGenMultilingualStringList(IReader reader, ITag tag, EngineDescription buildInfo)
		{
		...
		public SecondGenMultilingualStringList(ITag tag, StringRange[] ranges, EngineDescription buildInfo)
		{
			_layout = buildInfo.Layouts.GetLayout("unic");
			Tag = tag;
			Ranges = ranges;
