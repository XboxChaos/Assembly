...
namespace Blamite.Blam.Scripting.Compiler
{
    ...
    {
        private string _countEntryName;
        private string _addressEntryName;
        private string _layoutName;
        private List<ScriptObjectReflexive> _children = new List<ScriptObjectReflexive>();
        ...
        private string GetObjectName(StructureValueCollection values, StringIDSource stringIDs)
        {
            ...
            else if (values.HasInteger("name stringid"))
            {
                StringID sid = new StringID(values.GetInteger("name stringid"));
