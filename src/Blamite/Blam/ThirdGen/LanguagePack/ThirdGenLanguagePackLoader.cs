...
namespace Blamite.Blam.ThirdGen.LanguagePack
{
    ...
    public class ThirdGenLanguagePackLoader : ILanguagePackLoader
    {
        ...
        private List<GameLanguage> _languages;
        private List<ThirdGenMultilingualStringList> _groups = new List<ThirdGenMultilingualStringList>();
        ...
        public ThirdGenLanguagePackLoader(ICacheFile cacheFile, ThirdGenLanguageGlobals languageGlobals, EngineDescription buildInfo, IReader reader)
        {
