...
namespace Blamite.Blam.Resources.Models
{
    ...
    public class VertexBufferWriter
    {
        ...
        private Stack<BoundingBox> _bboxStack = new Stack<BoundingBox>();
        ...
        public void WriteElement(float x, float y, float z, float w, VertexElementLayout layout)
        {
            ...
            switch (layout.Type)
            {
                ...
                default:
                    throw new NotSupportedException("Unsupported vertex element type: " + Enum.GetName(typeof(VertexElementType), layout.Type));
            }
        }
