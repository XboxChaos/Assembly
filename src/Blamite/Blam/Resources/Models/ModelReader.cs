...
namespace Blamite.Blam.Resources.Models
{
    ...
    public static class ModelReader
    {
        ...
        private static void ReadSectionVertices(IReader reader, IModelSection section, BoundingBox boundingBox, EngineDescription buildInfo, IModelProcessor processor)
        {
