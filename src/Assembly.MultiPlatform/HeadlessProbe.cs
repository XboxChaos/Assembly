...
namespace Assembly.MultiPlatform
{
	...
	///     Usage: Assembly --headless [cache-file] [tag-name-substring]
	///
	...
	///     Usage: Assembly --edit-test cache-file tag-name-substring field-name new-value
	///
	...
	///     Usage: Assembly --perf-test cache-file
	///
	...
	///     Usage: Assembly --palette-bench [tag-count, default 12000]
	/// </summary>
	internal static class HeadlessProbe
	{
		...
		///     Usage: Assembly --ce-mutate-tag-file &lt;path-to-.ubulk&gt; &lt;field-name&gt; &lt;new-int-value&gt;
		/// </summary>
		...
		///     Usage: Assembly --fifthgen-roundtrip &lt;path-to-.utoc&gt;
		/// </summary>
		...
		///     Usage: Assembly --ce-unpack &lt;source&gt; &lt;output-dir&gt; [--all-chunks]
		/// </summary>
		...
		///     Usage: Assembly --ce-repack &lt;source&gt; &lt;tags-dir&gt; &lt;output-dir&gt;
		/// </summary>
		...
		///     Usage: Assembly --iostore-inspect &lt;path-to-.utoc&gt;
		/// </summary>
