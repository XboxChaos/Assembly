...
{
	/// <summary>
	///     Editor for <see cref="Assembly.MultiPlatform.Services.MetaFieldKind.StringId" />/
	///     <see cref="Assembly.MultiPlatform.Services.MetaFieldKind.OldStringId" />. A stringID is an
	...
	///     (see <see cref="Assembly.MultiPlatform.ViewModels.TagDocumentViewModel.SearchStringIds" />'s
