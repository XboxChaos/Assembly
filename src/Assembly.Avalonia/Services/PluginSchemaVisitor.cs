...
namespace Assembly.Avalonia.Services
{
	...
	public sealed class PluginSchemaVisitor : IPluginVisitor
	{
		...
		private void Add(MetaFieldKind kind, string name, uint offset, int size = 0,
			string? tooltip = null, string? note = null, List<(string, long)>? choices = null)
		{
		...
		// ---- scalars ----
		public void VisitUInt8(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.UInt8, n, o, 1, t);
		public void VisitInt8(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Int8, n, o, 1, t);
		public void VisitUInt16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.UInt16, n, o, 2, t);
		public void VisitInt16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Int16, n, o, 2, t);
		public void VisitUInt32(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.UInt32, n, o, 4, t);
		public void VisitInt32(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Int32, n, o, 4, t);
		public void VisitUInt64(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.UInt64, n, o, 8, t);
		public void VisitInt64(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Int64, n, o, 8, t);
		public void VisitFloat32(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Float32, n, o, 4, t);
		public void VisitUndefined(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Undefined, n, o, 4, t);
		public void VisitDatum(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Datum, n, o, 4, t);

		// ---- vectors / angles ----
		public void VisitPoint2(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Point2, n, o, 8, t);
		public void VisitPoint3(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Point3, n, o, 12, t);
		public void VisitVector2(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Vector2, n, o, 8, t);
		public void VisitVector3(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Vector3, n, o, 12, t);
		public void VisitVector4(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Vector4, n, o, 16, t);
		public void VisitDegree(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Degree, n, o, 4, t);
		public void VisitDegree2(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Degree2, n, o, 8, t);
		public void VisitDegree3(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Degree3, n, o, 12, t);
		public void VisitPlane2(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Plane2, n, o, 12, t);
		public void VisitPlane3(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Plane3, n, o, 16, t);
		public void VisitRect16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Rect16, n, o, 8, t);
		public void VisitQuat16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Quat16, n, o, 8, t);
		public void VisitPoint16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.Point16, n, o, 4, t);

		// ---- ids / references ----
		public void VisitStringID(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.StringId, n, o, 4, t);
		public void VisitOldStringID(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.OldStringId, n, o, 4, t);
		...
		// ---- ranges ----
		public void VisitRangeInt16(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.RangeInt16, n, o, 4, t);
		public void VisitRangeFloat32(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.RangeFloat32, n, o, 8, t);
		public void VisitRangeDegree(string n, uint o, bool v, uint l, string t) => Add(MetaFieldKind.RangeDegree, n, o, 8, t);

		// ---- blobs / strings ----
		public void VisitRawData(string n, uint o, bool v, int size, uint l, string t) => Add(MetaFieldKind.RawData, n, o, size, t);
		public void VisitAscii(string n, uint o, bool v, int size, uint l, string t) => Add(MetaFieldKind.Ascii, n, o, size, t);
		public void VisitUtf16(string n, uint o, bool v, int size, uint l, string t) => Add(MetaFieldKind.Utf16, n, o, size, t);
		public void VisitHexString(string n, uint o, bool v, int size, uint l, string t) => Add(MetaFieldKind.HexString, n, o, size, t);
		...
		{
			Add(MetaFieldKind.TagBlock, n, o, 8, t, note: $"entry size 0x{entrySize:X}");
			_depth++;
