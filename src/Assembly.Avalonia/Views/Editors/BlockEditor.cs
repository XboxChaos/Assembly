...
{
	/// <summary>
	///     Editor for <see cref="Assembly.Avalonia.Services.MetaFieldKind.TagBlock" /> - shared by
	///     a classic tag block and a Campaign Evolved block/array/struct container field (see
	///     <see cref="Assembly.Avalonia.ViewModels.TagDocumentViewModel.GetFifthGenContainerDef" />,
	///     which reuses the same <see cref="Assembly.Avalonia.Services.MetaFieldKind.TagBlock" />
	///     kind for its own containers). Element navigation itself
	///     (<see cref="Assembly.Avalonia.ViewModels.TagDocumentViewModel.SetElementIndex" />) is
	...
	///     <see cref="Assembly.Avalonia.ViewModels.MetaRowViewModel.ElementsBaseFileOffset" />).
	/// </summary>
