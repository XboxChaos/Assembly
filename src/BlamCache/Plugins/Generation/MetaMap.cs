...
namespace ExtryzeDLL.Plugins.Generation
{
    ...
    {
        private HashSet<MetaMap> _ancestors = new HashSet<MetaMap>();
        private SortedList<int, MetaValueGuess> _guesses = new SortedList<int, MetaValueGuess>();
        private SortedList<int, MetaMap> _submaps = new SortedList<int, MetaMap>();
        private SortedList<int, int> _sizeEstimates = new SortedList<int, int>(); // Maps size estimate -> frequency of estimate
        ...
        public int GetBestSizeEstimate()
        {
            int highestSize = 0;
            int highestFreq = 0;
            foreach (KeyValuePair<int, int> estimate in _sizeEstimates)
            {
