...
namespace ExtryzeDLL.IO
{
    ...
    {
        private int _defaultOffsetAlign = 1;
        private List<InternalSegment> _segmentsById = new List<InternalSegment>();
        private SortedList<int, InternalSegment> _segmentsByOffset = new SortedList<int, InternalSegment>();
        ...
        {
            var segments = _segmentsByOffset.Values;
