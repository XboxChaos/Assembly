...
namespace Assembly.Helpers.PostGeneration
{
    public class BlamitePostGenerator
    {
        ...
        public string Parse()
        {
            ...
            modInfoList += BBCodeListOption(BBCodeBold("Patch Download: ") + BBCodeUrl("Download", PostInfo.ModPatchDownload), true);
            ...
            // Attributes
            var attributeList = "";
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.WeaponEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Weapon Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.WeaponBalances ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Weapon Balances", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.WeatherEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Weather Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.TextureEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Texture Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.ProjectileEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Projectile Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.MachineEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Machine Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.SceneryEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Scenery Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.BipdEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Bipd Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.VehicleEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Vehicle Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.LighingEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Lighing Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.JmadEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Jmad Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.EffectEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Effect Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.ModelEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Model Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.PhysicsEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Physics Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.BarrierEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Barrier Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.AiEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Ai Edits", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.BlfMapinfoEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Custom Blf/Mapinfos", true);
            attributeList += BBCodeListOption("[ " + BBCodeBold(PostInfo.OtherEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) + " ] Other Edits", true);
            ...
            if (PostInfo.Images.Count > 0)
            {
                ...
                // Images
                var imageList = "";
                foreach (var image in PostInfo.Images)
            ...
            if (PostInfo.Thanks.Count > 0)
            {
                ...
                // Thanks
                var thanksList = "";
                foreach (var thank in PostInfo.Thanks)
