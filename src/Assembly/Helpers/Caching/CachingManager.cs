...
namespace Assembly.Helpers.Caching
{
	public class CachingManager
	{
			...
			string mapInternalName)
		{
			...
			// Get Target Game
			MetaContentModel.GameEntry selectedGameEntry = (from game in BlamCacheMetaData.Games
			...
			// Get Target Metadata
			MetaContentModel.GameEntry.MetaDataEntry selectedMetaData = (from metadata in selectedGameEntry.MetaData
