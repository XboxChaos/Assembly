...
namespace Assembly.Windows
{
	...
	public partial class Home
	{
		public Home()
		{
			...
			if (!double.IsNaN(App.AssemblyStorage.AssemblySettings.ApplicationSizeHeight) && App.AssemblyStorage.AssemblySettings.ApplicationSizeHeight > MinHeight)
				Height = App.AssemblyStorage.AssemblySettings.ApplicationSizeHeight;
			if (!double.IsNaN(App.AssemblyStorage.AssemblySettings.ApplicationSizeWidth) && App.AssemblyStorage.AssemblySettings.ApplicationSizeWidth > MinWidth)
				Width = App.AssemblyStorage.AssemblySettings.ApplicationSizeWidth;

			WindowState = App.AssemblyStorage.AssemblySettings.ApplicationSizeMaximize ? WindowState.Maximized : WindowState.Normal;
			Window_StateChanged(null, null);
		...
		readonly Dictionary<ContentTypes, ContentFileHandler> _contentFileHandlers = new Dictionary<ContentTypes, ContentFileHandler> {
