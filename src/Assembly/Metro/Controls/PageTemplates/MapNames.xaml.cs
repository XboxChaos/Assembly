...
namespace Assembly.Metro.Controls.PageTemplates
{
	...
	public partial class MapNames : UserControl
	{
		public MapNames()
		{
			...
			listH2am.ItemsSource = Halo2A.Where(e => e.Type == MapType.Multiplayer);
